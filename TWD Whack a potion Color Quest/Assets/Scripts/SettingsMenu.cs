   ...
   public void OnItemClick (int index) {
      ...
      switch (index) {
         case 0: 
				//first button
            Debug.Log ("Music") ;
            SSTools.ShowMessage("Music",SSTools.Position.bottom , SSTools.Time.threeSecond);
            break ;
         case 1: 
				//second button
            Debug.Log ("Sounds") ;
            SSTools.ShowMessage("Sounds",SSTools.Position.bottom , SSTools.Time.threeSecond);
            break ;
         case 2: 
				//third button
            Debug.Log ("Vibration") ;
            SSTools.ShowMessage("Vibration",SSTools.Position.bottom , SSTools.Time.threeSecond);
            break ;
      }
   }
